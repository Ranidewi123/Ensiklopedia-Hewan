...
public class OmnActivity extends AppCompatActivity implements HewanAdapter.IHewanAdapter {
    ...
    private void fillData() {
        ...
        String[] arDetail = resources.getStringArray(R.array.hewanomn_details);
